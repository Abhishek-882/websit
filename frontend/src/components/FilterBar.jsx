      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-2.5 sm:gap-3 pb-2.5 sm:pb-3 border-b border-slate-800/80">
        ...
        <div className="flex flex-wrap items-center justify-between sm:justify-end gap-2">
          ...
          >
            ...
            <span>Filters</span>
            {activeFilterCount > 0 && (
              <span className="h-4 w-4 rounded-full bg-cyan-500 text-slate-950 font-bold text-[10px] flex items-center justify-center font-mono">
                {activeFilterCount}
              </span>
            )}
            <svg className="w-3 h-3 text-slate-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
              {isExpandedMobile ? <polyline points="18 15 12 9 6 15" /> : <polyline points="6 9 12 15 18 9" />}
            </svg>
          </button>
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 px-2 sm:px-3 py-1 sm:py-1.5 rounded-lg bg-slate-900 border border-slate-700/80 shadow-inner">
            <span className="text-[11px] font-semibold text-slate-300 flex items-center gap-1">
              <span className="text-slate-400 uppercase text-[10px] tracking-wider font-mono">Exit Rule:</span>
